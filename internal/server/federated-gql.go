...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "Capsule":
			resolverName, err := entityResolverNameForCapsule(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Capsule": %w`, err)
			}
			switch resolverName {
			...
			case "findCapsuleByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findCapsuleByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindCapsuleByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Capsule": %w`, err)
				}
...
func entityResolverNameForCapsule(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
		...
		return "findCapsuleByID", nil
	}
	return "", fmt.Errorf("%w for Capsule", ErrTypeNotFound)
}
